...
impl<'ctx> CodeGenerator<'ctx> {
    ...
    pub(super) fn compile_getenv(
        ...
        let str_alloca = self
            .builder
            .build_alloca(string_ty, "getenv_str")
        ...
        self.builder
            .build_store(ptr_gep, i8_ptr.const_null())
            .map_err(|e| format!("store error: {}", e))?;
        self.builder
            .build_store(len_gep, zero_i64)
            .map_err(|e| format!("store error: {}", e))?;
        let is_null = self
            .builder
            .build_int_compare(
        ...
        self.builder
            .build_conditional_branch(is_null, merge_bb, not_null_bb)
    ...
    pub(super) fn compile_args(
        ...
        let count_fn = self
            .module
            .get_function("mimi_args_count")
            .ok_or_else(|| "codegen: mimi_args_count not declared".to_string())?;
        let call = self
            .builder
            .build_call(count_fn, &[], "args_count_call")
